...
export const INSIGHTS: Insight[] = [
  ...
  },
  {
    ...
    body: 'Major tech firms announced 60,000 layoffs in the past 30 days. Across all sectors, the average job search takes 5.1 months. With only 3.1 months of expenses saved, you\'re exposed. One more month of buffer changes everything.',
    impact: 'You need 2 more months of runway to reach the safety zone',
    impactType: 'negative',
    tag: 'ECONOMY',
    timeAgo: '4h ago',
    saved: false,
  ...
  },
  {
    ...
    impact: '18 points separates you from prime lending rates',
    impactType: 'positive',
    tag: 'CREDIT',
    timeAgo: '12h ago',
    saved: false,
  },
  {
    ...
    impact: 'At your savings rate, you hit retirement target in 28 years',
    impactType: 'neutral',
    tag: 'MACRO',
    timeAgo: '1d ago',
    saved: false,
